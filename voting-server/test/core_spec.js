...
describe('application logic', () => {
	...
	describe('setEntries', () => {
		...
		it('should convert the entries to immutable', () => {
			const state = Map();
	...
	describe('next', () => {
		...
		it('should put the winner of current vote back to entries', () => {
			const state = Map({
				vote: Map({
					pair: List.of('Trainspotting', '28 Days Later'),
					tally: Map({
		...
		it('should put both from tied vote back to entries', () => {
			const state = Map({
				vote: Map({
					pair: List.of('Trainspotting', '28 Days Later'),
					tally: Map({
	...
	describe('vote', () => {
		...
		it('should increment the tally if it already exists', () => {
			const state = Map({
				pair: List.of('Trainspotting', '28 Days Later'),
				tally: Map({
					'Trainspotting': 3,
